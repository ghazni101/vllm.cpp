...
- Row: `BACKEND-ROCM`
- Branch: `row/ROCM-PP-TILED-KQUANT`
...
1. `ctest -R 'quant_dot'` — all G3 cases pass
2. Token-exact vs baseline binary on Qwen3.5-4B Q4_K_M
3. A/B: prefill throughput improvement at PP 228 (the profiled shape) and PP 1821 (the longest prompt)
