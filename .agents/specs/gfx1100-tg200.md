...
`ACTIVE`. Position: 77.7 tok/s median at the T9 config (T9 evidence,
`docs/bench-evidence/gfx1100-tg200-t9-coop-gated-norm-20260825.md`).
...
gated norm (+2.6%). Closed negative: T5c MMVQ nontemporal loads, T7 COALK
...
Next attack: GdnScanCoop (0.730 ms/tok) and GdnPostConvChunked (~0.67),
then wvSplitKSml's 408 GB/s vs the 598 reference. Owed before ANY default
flip of the opt-in arms (GQA4 / GDN_SCAN_COOP / PREAMBLE_COOP /
RMSNORM_ROW_COOP / GDN_NORMGATED_COOP):
